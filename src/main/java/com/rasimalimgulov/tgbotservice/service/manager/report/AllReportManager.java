...
public class AllReportManager extends AbstractManager {
    final AnswerMethodFactory methodFactory;
    final KeyboardFactory keyboardFactory;
    final UserSessionManager userSessionManager;
    final WebFluxBuilder webFluxBuilder;
    final SendExcelFile sendExcelFile;
    public AllReportManager(AnswerMethodFactory methodFactory, KeyboardFactory keyboardFactory, UserSessionManager userSessionManager, WebFluxBuilder webFluxBuilder, SendExcelFile sendExcelFile) {
    ...
    public BotApiMethod<?> answerCallbackQuery(CallbackQuery callbackQuery, Bot bot) {
        ...
        switch (callbackData) {
            case ALL_REPORT: {
                session.setReportType(ALL_REPORT);
            ...
            case ALL_REPORT_TOTAL:{
             return sendTotalReport(session,chatId,bot);
            }
            default:
                return null;
        }
    }
    public BotApiMethod<?> sendTotalReport(UserSession session, Long chatId, Bot bot) {
        byte[] fileData = null;
        try {
